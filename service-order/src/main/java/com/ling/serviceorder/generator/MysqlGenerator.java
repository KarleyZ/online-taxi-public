package com.ling.serviceorder.generator;
...
public class MysqlGenerator {
    ...
    public static void main(String[] args) {
        FastAutoGenerator.create("jdbc:mysql://localhost:3306/service-order?characterEncoding=utf-8&serverTimezone=GMT%2B8","root","123456")
                .globalConfig(builder -> {
                    builder.author("ling").fileOverride().outputDir("E:\\MSB\\online-taxi-public\\service-order\\src\\main\\java");
                })
                .packageConfig(builder -> {
                    builder.parent("com.ling.serviceorder").pathInfo(Collections.singletonMap(OutputFile.mapperXml,
                            "E:\\MSB\\online-taxi-public\\service-order\\src\\main\\java\\com\\ling\\serviceorder\\mapper"));
                }).strategyConfig(builder -> {
